"""
Django settings for vizipedia project.
...
WSGI_APPLICATION = "vizipedia.wsgi.application"
...
DATABASES = {
    'nhl_db': dj_database_url.config(default=os.getenv('DATABASE_URL'))
}
...
STATICFILES_DIRS = [
    os.path.join(os.path.dirname(os.path.dirname(REACT_APP_DIR)), 'build', 'static'),
    os.path.join(os.path.dirname(os.path.dirname(REACT_APP_DIR)), 'build', 'markdown'),
]
